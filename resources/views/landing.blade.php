...
<body>
    ...
    <div class="event-box">
        <div>
            ...
            <p><a href="/home" style="color: black;">VIEW EVENTS NEAR YOU ↓</a></p>
        </div>
        <div class="event-details">
            <p>May 11–June 20, 2025</p>
            <p>NU-LAG</p>
            <p>4-A, PHL</p>
            <a href="/account/create">REGISTER NOW!</a>
        </div>
    </div>
 ...
 <div class="lineup-section">
    ...
    <div class="artist-card">
        ...
        <div class="artist-details">
            ...
            <a href="/home" class="ticket-btn">FIND<br>LOCALS</a>
        </div>
    </div>
    ...
    <div class="artist-card">
        ...
        <div class="artist-details">
            ...
            <a href="/home" class="ticket-btn">BOOK<br>TABLES</a>
        </div>
    </div>
</div>
...
<section class="ticket-section">
    <div class="ticket-top">
        ...
        <div class="ticket-info">
            ...
            <p class="price">$0</p>
            <a href="/account/create" class="buy-link">REGISTER NOW</a>
        </div>
    </div>
